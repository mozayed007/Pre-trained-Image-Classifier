...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    with open(dogfile,"r") as Infile:
      ...
      # Iterate through each key in results_dic
    for key in results_dic:
        # Check if pet image label is a dog
        results_dic[key].append(1 if results_dic[key][0] in dog_names else 0)

        # Check if classifier label is a dog
        results_dic[key].append(1 if results_dic[key][1] in dog_names else 0)